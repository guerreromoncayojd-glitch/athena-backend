...
def seed_data(db):
    ...
    def _fecha_partido(dias_desde_hoy: int, indice: int) -> datetime:
        hora = horas_tipicas[indice % len(horas_tipicas)]
        base = datetime.now(timezone.utc) + timedelta(days=dias_desde_hoy)
